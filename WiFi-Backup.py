...
# Authors:	Seinu Purpose:	Backup WiFi Keys from MacOS, Windows and Linux
# History:
#     * 01/26/2015 - v1.0
...
#     * 11/20/2018 - v2.0a
#         completely rewrote script in python with multiplatform support for both Windows and MacOS
#     * 11/20/2018 - v2.0b
